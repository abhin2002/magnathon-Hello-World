...
days = {'Monday':1,'Tuesday':2,'Wednesday':3,'Thursday':4,'Friday':5,'Saturady':6,'Sunday':7}
# modes and themes
...
logo = customtkinter.CTkImage(light_image=Image.open("C:/Users/91964/OneDrive/Desktop/hackathon/images/cooking.ico"),size=(100,100))
appamEgg = customtkinter.CTkImage(light_image=Image.open("C:/Users/91964/OneDrive/Desktop/hackathon/images/appam egg.jfif"),size=(200,200))
bread = customtkinter.CTkImage(light_image=Image.open("C:/Users/91964/OneDrive/Desktop/hackathon/images/bread butter jam.jfif"),size=(200,200))
cib = customtkinter.CTkImage(light_image=Image.open("C:/Users/91964/OneDrive/Desktop/hackathon/images/cb.jfif"),size=(200,200))
mainlogo =customtkinter.CTkImage(light_image=Image.open("C:/Users/91964/OneDrive/Desktop/hackathon/images/waste logoBgless.png"),size=(300,300))
gheerice =customtkinter.CTkImage(light_image=Image.open("C:/Users/91964/OneDrive/Desktop/hackathon/images/ghee rice.jfif"),size=(200,200))
meals =customtkinter.CTkImage(light_image=Image.open("C:/Users/91964/OneDrive/Desktop/hackathon/images/meals.jfif"),size=(200,200))
upma =customtkinter.CTkImage(light_image=Image.open("C:/Users/91964/OneDrive/Desktop/hackathon/images/upma.jfif"),size=(200,200))
puttu =customtkinter.CTkImage(light_image=Image.open("C:/Users/91964/OneDrive/Desktop/hackathon/images/putt&kadala.jfif"),size=(200,200)) 
#------------------------------------ LAYERS --------------------------------------------------------------------
...
def UPDATE():
   ...
   if(day1=="Monday"):
      ...
      if(time1=="Breakfast"):
         ...
         egg1= customtkinter.CTkLabel(master=display1,text='Egg thoran',width=100,fg_color=("white", "gray38"),corner_radius=6)  
...
def ENTER():
    ...
    if(day3=="Monday"):
      ...
      if(time3=="Breakfast"):
         ...
         egg3= customtkinter.CTkLabel(master=display,text=f"Egg thoran {p[10]} kg",font=("Sanserif",20),width=100,corner_radius=6)  
         ...
         Iddiyappam3= customtkinter.CTkLabel(master=display,text=f"Iddiyappam {p[13]} kg",font=("Sanserif",20),width=100,corner_radius=6)  
